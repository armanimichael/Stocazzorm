...
namespace Stocazzorm.Generator;
...
internal class DataRecordMapperGenerator : IIncrementalGenerator
{
    ...
    private static TypeDeclarationSyntax? GetSemanticTargetForGeneration(GeneratorSyntaxContext context)
    {
        ...
        foreach (AttributeListSyntax attributeListSyntax in typeDeclarationSyntax.AttributeLists)
        {
            foreach (AttributeSyntax attributeSyntax in attributeListSyntax.Attributes)
            {
                ...
                if (fullName == "Stocazzorm.DataRecordMapperAttribute")
                {
                    // return the enum
    ...
    static List<TypeToGenerate> GetTypesToGenerate(Compilation compilation, IEnumerable<TypeDeclarationSyntax> types, CancellationToken ct)
    {
        ...
        var mapperAttribute = compilation.GetTypeByMetadataName("Stocazzorm.DataRecordMapperAttribute");
        var mapColumnAttribute = compilation.GetTypeByMetadataName("Stocazzorm.MapColumnAttribute");
        var noMapAttribute = compilation.GetTypeByMetadataName("Stocazzorm.NoMapAttribute");
